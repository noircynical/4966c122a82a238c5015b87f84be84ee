...
public class BNField6 {
    ...
    public BNField6 multiply(BNField6 w) {
        ...
        BNField2
            d00 = v[0].multiply(w.v[0]),
            d11 = v[1].multiply(w.v[1]),
            d22 = v[2].multiply(w.v[2]),
    ...
    public BNField6 multiplyConj() {
        ...
        if (bn.b == 3 || bn.b == 5) {
            return new BNField6(bn,
                v[0].square().subtract(v[1].multiply(v[2]).divideV()),
            ...
            return new BNField6(bn,
                v[0].square().subtract(v[1].multiply(v[2]).multiplyV()),
    ...
    public BNField2 normCompletion(BNField6 k){
        BNField2
            ...
            d12 = v[1].multiply(k.v[2]).add(v[2].multiply(k.v[1]));
        if (bn.b == 3 || bn.b == 5) {

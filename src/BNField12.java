...
public class BNField12 {
        ...
        if (k.v[2].isZero() && k.v[4].isZero() && k.v[5].isZero()) {
            if (v[2].isZero() && v[4].isZero() && v[5].isZero()) {
                BNField2
                    ...
                    t01 = k.v[0].add(k.v[1]),
                    u01 = d00.add(d11),
                    z01 = s01.multiply(t01),
                    d01 = z01.subtract(u01),
                    d13 = v[1].add(v[3]).multiply(k.v[1].add(k.v[3])).subtract(d11.add(d33));
                u01 = u01.add(d01);
                BNField2
                    d03 = s01.add(v[3]).multiply(t01.add(k.v[3])).subtract(u01.add(d33).add(d13)),
    ...
    public void decompress(BNField12 h){
        ...
        if(!h.v[1].isZero()){
            if(bn.b == 2){
                ...
                h.v[0] = h.v[3].square().twice(1).add(h.v[1].multiply(h.v[5])).subtract(h.v[4].
                                                                    multiply(h.v[2]).multiply(3)).multiplyV().add(BigInteger.ONE);
            }
            else {
                h.v[3] = h.v[5].square().divideV().add(h.v[2].square().multiply(3)).subtract(h.v[4].twice(1)).
                                                                                            multiply(h.v[1].twice(2).inverse());
                h.v[0] = h.v[3].square().twice(1).add(h.v[1].multiply(h.v[5])).subtract(h.v[4].
                                                                    multiply(h.v[2]).multiply(3)).divideV().add(BigInteger.ONE);
            }
        }
        else{
            h.v[3] = h.v[2].multiply(h.v[5]).twice(1).multiply(h.v[4].inverse());
            h.v[0] = h.v[3].square().twice(1).subtract(h.v[4].multiply(h.v[2]).multiply(3)).multiplyV().add(BigInteger.ONE);
        }
    }
    ...
    public BNField12 square() {
        ...
        System.out.println("Chung-Hasan mods: " + BNField2.getmod());
        System.exit(0);
        //*/
    ...
    public BNField12 uniSquare() {
        ...
        a0sqr = v[0].square(); a1sqr = v[3].square();
        b0sqr = v[1].square(); b1sqr = v[4].square();
        c0sqr = v[2].square(); c1sqr = v[5].square();
        if (bn.b == 3 || bn.b == 5) {
